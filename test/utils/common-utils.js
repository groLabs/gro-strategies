...
async function compareStrategeBalance(
  ...
  console.log('strategy ratio : ' + StrategyDebtRatios)
...
async function harvestStratgies(controller) {
  ...
  const [mockCurveStrategy] = CurveVaultAdaptor.strategies;
  await DAIVaultAdaptor.strategyHarvest(0)
  await DAIVaultAdaptor.strategyHarvest(1)
  await USDCVaultAdaptor.strategyHarvest(0)
  await USDCVaultAdaptor.strategyHarvest(1)
  await USDTVaultAdaptor.strategyHarvest(0)
  await USDTVaultAdaptor.strategyHarvest(1)
  await CurveVaultAdaptor.strategyHarvest(0)
}
...
async function investVaults(controller) {
  ...
  const lifeguard = controller.lifeguard;
  await DAIVaultAdaptor.setStrategyDebtRatioBuffer(10000)
  await USDCVaultAdaptor.setStrategyDebtRatioBuffer(10000)
  await USDTVaultAdaptor.setStrategyDebtRatioBuffer(10000)
...
const vaults = {
    daiVault: { address: '0x82e40E1626ebb4076419b49b9403d9Ce2425B956', name: "Gro DAI.e LAB", symbol: "groDAI.e", decimals: 18, mappingSlot: '0x9' },
    usdcVault: { address: '0x6518becA1c20221cF6e8ba6F77B85818d1a298E7', name: "Gro USDC.e LAB", symbol: "groUSDC.e", decimals: 6, mappingSlot: '0x9' },
    usdtVault: { address: '0x95284D91e69BEAcAaf90AD6Fd3d6C959Eb900BA4', name: "Gro USDT.e LAB", symbol: "groUSDT.e", decimals: 6, mappingSlot: '0x9' },
}
