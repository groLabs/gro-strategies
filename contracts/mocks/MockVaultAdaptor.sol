...
contract MockVaultAdaptor is IVault, Constants {
    ...
    function setStrategyDebtRatioBuffer(uint256 _strategyRatioBuffer) external {
        StrategyDebtRatioBuffer = _strategyRatioBuffer;
    }
    ...
    function setStrategyDebtRatio(uint256[] calldata debtratios) external override {}
