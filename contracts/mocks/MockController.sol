...
contract MockController is Constants, IController, IWithdrawHandler, IDepositHandler {
    ...
    function setUnderlyingTokens(address[3] calldata tokens) external {
    ...
    function setCurveVault(address _curveVault) external {
    ...
    function addPool(address pool, address[] calldata tokens) external {
        tokens;
    ...
    function setWithdrawHandler(address handler) external {
        withdrawHandler = handler;
    }

    function setDepositHandler(address handler) external {
        depositHandler = handler;
    }

    function setEmergencyHandler(address handler) external {
    ...
    function restart(uint256[3] calldata allocations) external {}
